    ...
    <div className={cn("flex flex-col", className)} {...props}>
      ...
      {success ? (
        <div style={{ background: "#fff", borderRadius: "16px", border: "0.5px solid #e2e8f5", padding: "24px", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "15px", fontWeight: "500", color: "#0F1E3C", marginBottom: "8px" }}>Check your email</h2>
        ...
        <div style={{ background: "#fff", borderRadius: "16px", border: "0.5px solid #e2e8f5", padding: "24px" }}>
          <h2 style={{ fontSize: "15px", fontWeight: "500", color: "#0F1E3C", marginBottom: "4px" }}>Reset your password</h2>
          <p style={{ fontSize: "12px", color: "#64748b", marginBottom: "20px" }}>Enter your email and we will send you a reset link.</p>
          ...
          <form onSubmit={handleForgotPassword} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "10px 14px", borderRadius: "10px", border: "0.5px solid #e2e8f5", fontSize: "13px", color: "#0F1E3C", background: "#ffffff", outline: "none", WebkitAppearance: "none" }}
              />
            </div>
